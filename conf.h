...
vector colloid[maxcolloids], r[maxcolloids];
//vector patch[maxcolloids];
...
double	 box[2], rho[2];
double	 cutoff, lambda, temp, epsilon, epsilon1, pressure;
double	 U[2], V[2], W[2], Wi;
double	 aven[2], avdens[2], simuP[2];
double	 mu[2], mucalc[2];


double  cut2, cut3, invcut3, invcut6, Ucut;
